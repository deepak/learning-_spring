...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext newContext = new FileSystemXmlApplicationContext("spring.xml");

        Triangle shape1 = (Triangle) context.getBean("triangle");
        Triangle shape2 = (Triangle) context.getBean("triangle");

        Triangle newShape = (Triangle) newContext.getBean("triangle");
        ...
        System.out.println("shapes in same container are equal: " + shape1.equals(shape2));
        System.out.println("shapes in diff. container are equal: " + newShape.equals(shape1));
